export default {
    ...
    "SelectProgram": "Sélectionner un programme à afficher et importer le/la {outcome, select, competencies {compétences} expectations {attentes} objectives {objectifs} outcomes {résultats} standards {normes} other {normes}}.",
