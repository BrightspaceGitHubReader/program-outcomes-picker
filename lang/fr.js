export default {
   ...
   "Cancel" : "Annuler",
   "CheckedFalse" : "non coché",
   "CheckedMixed" : "à moitié coché",
   "CheckedTrue" : "coché",
   "Close" : "Fermer",
   "CloseDialog" : "Fermer cette boîte de dialogue",
   "Collapse" : "Réduire",
   "ConnectionError" : "Oups! Nous éprouvons des problèmes de connexion. Veuillez actualiser la page ou réessayer plus tard.",
   "DeleteOrphanedOutcomes" : "Supprimer les {outcome, select, competencies {compétences} expectations {attentes} objectives {objectifs} outcomes {résultats} standards {normes} other {normes}}",
   "Disabled" : "désactivé",
   ...
   "SelectProgram" : "Sélectionner un programme à afficher et importer le/la {résultat, sélection, compéteces {competencies} attentes {expectations} objectifs {learning objectives} résultats {learning outcomes} normes {standards} autre {standards}}.",
   ...
   "WarningDescription1" : "Vous êtes sur le point de supprimer le/la {résultat, sélection, compétences {competencies} attentes {expectations} objectifs {learning objectives} résultats {learning outcomes} normes {standards} autre {standards}}, mais les {résultat, sélection, compétences {competencies} attentes {expectations} objectifs {learning objectives} résultats {learning outcomes} normes {standards} autre {standards}} déjà créés y sont joints :",
   "WarningDescription2" : "Que voulez-vous faire avec le/la {résultat, sélection, compétences {competencies} attentes {expectations} objectifs {learning objectives} résultats {learning outcomes} normes {standards} autre {standards}} déjà créé(e)?",
