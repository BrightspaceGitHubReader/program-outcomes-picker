export default {
	...
	Collapse: 'Collapse',
	ConnectionError: 'Oops! We\'re having trouble connecting you. You might want to refresh the page, or try again later.',
	DeleteOrphanedOutcomes: 'Delete Authored {outcome, select, competencies {Competencies} expectations {Expectations} objectives {Objectives} outcomes {Outcomes} standards {Standards} other {Standards}}',
	Expand: 'Expand',
	...
	WarningDescription1: 'You\'re about to remove {outcome, select, competencies {competencies} expectations {expectations} objectives {learning objectives} outcomes {learning outcomes} standards {standards} other {standards}} to which the following authored outcomes are attached:',
	WarningDescription2: 'What would you like to do with these authored {outcome, select, competencies {competencies} expectations {expectations} objectives {learning objectives} outcomes {learning outcomes} standards {standards} other {standards}}?',
