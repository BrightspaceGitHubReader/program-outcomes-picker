export default {
    ...
    "Delete": "삭제",
    "DeleteOrphanedOutcomes": "{outcome, select, competencies {역량} expectations {기대} objectives {목표} outcomes {결과} standards {표준} other {표준}} 삭제",
    "Disabled": "비활성화됨",
    ...
    "SelectProgram": "프로그램을 선택하여 {outcome, select, competencies {역량} expectations {기대} objectives {학습 목표} outcomes {학습 결과} standards {표준} other {표준}}를 보고 가져오기 합니다.",
    "SelectSubject": "주제 선택",
    "Subject": "제목",
